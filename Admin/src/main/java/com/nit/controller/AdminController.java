...
public Flight[] getAllFlights() throws InterruptedException{
	Flight[] flight=restTemplate.getForObject("https://FlightSearch/Search/allFlights", Flight[].class);
	Thread.sleep(3000);
	return flight;	
}
...
public Flight[] getFlightByData(@PathVariable("departure_location") String dep_loc,
	...
	Flight[] flight=restTemplate.getForObject("https://FlightSearch/Search/find/"+dep_loc+"/"+arr_loc, Flight[].class)	;
	Thread.sleep(3000);
	return flight;	
}
...
@PostMapping(value="/addFlights",consumes = MediaType.APPLICATION_JSON_VALUE,
...
restTemplate.postForObject("https://FlightSearch/Search/addFlights", flight, Flight.class);
Thread.sleep(3000);
return flight;
}
...
public String updateFlight(@RequestBody Flight flight,@PathVariable("id") int flights_id) throws InterruptedException{
	restTemplate.put("https://FlightSearch/Search/updateFlightsData/"+flights_id, flight);
	Thread.sleep(3000);
