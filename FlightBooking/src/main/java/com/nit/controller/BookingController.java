...
/*
 * @GetMapping("/find") 
 * public List<FlightData> findFlightData() { 
 * Flight flight  = restTemplate.getForObject("http://allFlights", Flight.class); return
 * flight.getFlight(); }
 */
 ...
 * ResponseEntity<Response> responseEntity = restTemplate.getForEntity("http://allFlights", Response.class);
